...
@interface TopicDetailsCell ()<UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MWPhotoBrowserDelegate>
...
{
    //    NSLog(@"count -- %ld", [_model.imgs componentsSeparatedByString:@","].count);
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    //    NSLog(@"imageStr -- %@%@", KAPI_Image,imageStr);
...
{
    return CGSizeMake(_model.dynamic_image_W, _model.dynamic_image_W * 0.75);
}
