...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, collectionViewY, self.view.width, collectionViewH) collectionViewLayout:layout];
